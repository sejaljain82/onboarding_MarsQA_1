...
@mytag 
Scenario:Seller is able Add Education tab
	Given Seller is on Education tab
    When Seller clicks on ‘Add New’ on Education tab
    But clikcs on 'Add' without adding data on Education tab
    Then A message "Please enter all the fields"appears  
